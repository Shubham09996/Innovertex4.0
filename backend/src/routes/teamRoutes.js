...
import { createTeam, getTeamsByHackathon, getTeamById, joinTeam, leaveTeam, inviteMember, respondToInvitation, removeMember, getUserTeam, updateTeam } from '../controllers/teamController.js';
import { protect, authorizeRoles } from '../middleware/authMiddleware.js';

router.route('/').post(protect, createTeam);
router.route('/hackathon/:hackathonId').get(getTeamsByHackathon);
router.route('/my-team/:hackathonId').get(protect, getUserTeam); // Re-added 'protect' middleware
