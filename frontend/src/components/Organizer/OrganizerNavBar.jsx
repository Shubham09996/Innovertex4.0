    ...
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm bg-nav border-b border-border">
      <div className="w-full px-6 flex items-center h-20">
        ...
        <nav className="hidden md:flex items-center gap-5 flex-none">
          <Link to="/organizer/dashboard" className={`text-text hover:text-primary transition-colors relative ${currentPath === '/organizer/dashboard' ? 'active-nav-item' : ''}`}>Dashboard</Link>
          <Link to="/organizer/hackathons" className={`text-text hover:text-primary transition-colors relative ${currentPath === '/organizer/hackathons' ? 'active-nav-item' : ''}`}>My Hackathons</Link>
            <Link to="/organizer/participants" className={`text-text hover:text-primary transition-colors relative ${currentPath === '/organizer/participants' ? 'active-nav-item' : ''}`}>Participants</Link>
            <Link to="/organizer/judges" className={`text-text hover:text-primary transition-colors relative ${currentPath === '/organizer/judges' ? 'active-nav-item' : ''}`}>Judges</Link>
            <Link to="/organizer/mentors" className={`text-text hover:text-primary transition-colors relative ${currentPath === '/organizer/mentors' ? 'active-nav-item' : ''}`}>Mentors</Link>
            <Link to="/organizer/announcements" className={`text-text hover:text-primary transition-colors relative ${currentPath === '/organizer/announcements' ? 'active-nav-item' : ''}`}>Announcements</Link>
