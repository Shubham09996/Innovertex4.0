...
const DashboardHero = () => {
  return (
    <section className="mb-8 p-6 bg-card rounded-xl shadow-lg">
      <h1 className="text-4xl font-bold text-text mb-4">Your Mission Control for Innovation 🚀</h1>
      <p className="text-muted text-lg mb-6">Ready to build something amazing? Your personalized hackathon journey starts here.</p>
