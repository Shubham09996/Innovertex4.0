...
const GlobalRankCard = () => {
  return (
    <section className="bg-card rounded-xl shadow-lg p-6 text-center">
      ...
      <Link to="/participant/leaderboard" className="w-full mt-6 px-4 py-2 bg-bg-elev border border-border text-text rounded-full font-semibold hover:bg-border-2 transition-colors duration-200 text-center block">View Full Leaderboard</Link>
    </section>
  );
};
