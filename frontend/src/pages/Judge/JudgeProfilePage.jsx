...
const JudgeProfilePage = () => {
  ...
  const [profile, setProfile] = useState({
    ...
    bio: "Senior Software Engineer with 10+ years of experience in AI/ML and full-stack development. Passionate about mentoring developers and evaluating innovative projects. I believe in the power of technology to solve real-world problems.",
    avatar: "https://randomuser.me/api/portraits/women/44.jpg",
    skills: ["AI/ML", "Python", "React", "Node.js", "Machine Learning", "Data Science"],
    certificates: [
      { id: 1, name: "Machine Learning Specialization", authority: "Stanford", date: "Jan 2021" },
      { id: 2, name: "Advanced React Development", authority: "Meta", date: "Apr 2021" },
      { id: 3, name: "Cloud Architecture Professional", authority: "AWS", date: "Sep 2021" },
    ],
  });

  const [badges] = useState([
    { id: 1, name: "Expert Judge", icon: "⚖️", desc: "Top-rated judge with 50+ evaluations" },
    { id: 2, name: "Mentor Champion", icon: "🎓", desc: "Mentored 100+ developers" },
    { id: 3, name: "Innovation Catalyst", icon: "💡", desc: "Identified breakthrough projects" },
    { id: 4, name: "Fair Evaluator", icon: "⚖️", desc: "Consistent and fair evaluations" },
    { id: 5, name: "Tech Leader", icon: "👑", desc: "Leading technology expert" },
  ]);
    ...
    <main className="min-h-screen bg-bg text-text py-24 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="flex-1">
                ...
                <div className="mt-6 flex flex-wrap gap-3 items-center">
                  ...
                  <div className="ml-auto hidden md:flex items-center gap-4">
                    <StatMini label="Evaluations" value={stats.evaluations} />
          ...
          {activeTab === "Activity" && (
            <div className="space-y-6">
              ...
              >
                ...
                <p className="mt-4 text-sm text-muted">Consistent evaluation activity earns bonus points & badges.</p>
              </motion.div>
              ...
              >
                ...
                <ul className="space-y-3">
                  <ActivityItem title="Evaluated AI Innovation Challenge projects" time="2 days ago" accent="from-pink-500 to-purple-500" />
                  <ActivityItem title="Mentored Web3 Development teams" time="7 days ago" accent="from-indigo-500 to-blue-400" />
                  <ActivityItem title="Judged Fintech Revolution submissions" time="12 days ago" accent="from-green-400 to-teal-300" />
                </ul>
              </motion.div>
            </div>
          )}
        ...
        <aside className="space-y-6">
          ...
          >
            <h4 className="text-sm text-muted mb-4">Judge Standing</h4>
            <CircularRank percent={88} rank="#12" points={stats.points} />
            <div className="mt-6 space-y-3 text-left">
              <div className="flex justify-between text-sm">
                <span className="text-muted">Evaluation Accuracy</span>
                <span className="font-semibold text-text">96%</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-muted">Participant Rating</span>
                <span className="font-semibold text-text">4.9/5</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-muted">Mentorship Impact</span>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              <SmallStat label="Evaluations" value={stats.evaluations} color="indigo" />
...
const CircularRank = ({ percent = 70, rank = "#12", points = 1500 }) => {
